...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-6xl mx-auto py-8">
        <div class="bg-white rounded-lg shadow-lg border border-gray-200 p-8 print:shadow-none print:border-none">
            
            <!-- Report Header -->
            <div class="border-b border-gray-200 pb-6 mb-8 print:border-gray-400">
                <div class="flex justify-between items-start mb-6">
                    <div>
                        <h1 class="text-4xl font-bold text-blue-900 mb-3">System Analysis Report</h1>
                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                            <p class="text-lg font-semibold text-blue-900">Incident ID: #{{ str_pad($log->id, 6, '0', STR_PAD_LEFT) }}</p>
                            <p class="text-sm text-blue-700">Generated on {{ now()->format('F j, Y \a\t g:i A T') }}</p>
                        </div>
                    </div>
                    <div class="text-right">
                        <div class="bg-white border border-gray-300 rounded-lg p-4">
                            <div class="text-lg font-bold text-gray-800">ServerPulse Monitoring</div>
            ...
            @endif            <!-- Recommendations and Action Items -->
            <div class="mb-8">
                <h2 class="text-2xl font-bold text-gray-900 mb-6 flex items-center">
            ...
            <div class="border-t border-gray-200 pt-6 print:border-gray-400">
                ...
                <div class="flex justify-between items-center text-sm text-gray-600">
                    ...
                    <div class="text-right">
                        ...
                        <p><strong>Generated on:</strong> {{ now()->format('F j, Y \a\t g:i A T') }}</p>
                    </div>
                </div>
            </div>            <!-- Action Buttons -->
            <div class="flex justify-between items-center pt-6 border-t border-gray-200 mt-8 print:hidden">
                <a href="{{ route('logs.show', $log) }}" class="inline-flex items-center px-6 py-3 bg-white text-blue-600 border border-blue-600 rounded-lg hover:bg-blue-50 transition-colors duration-200 font-medium">
                ...
                <div class="flex space-x-3">
                    ...
                    <a href="{{ route('logs.index') }}" class="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 font-medium">
